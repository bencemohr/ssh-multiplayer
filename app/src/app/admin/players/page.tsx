  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className={`flex items-center gap-2 ${inputBg} border ${inputBorder} rounded px-4 py-2 flex-1 max-w-md`}>
          ...
          <input
            ...
            className={`bg-transparent ${textTertiary} font-mono focus:outline-none flex-1`}
          />
        </div>
